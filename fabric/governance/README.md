...
This module is the initial ViewSense sovereign-control plane. It owns provider passports, evaluation records, explicit admission decisions, and payload-minimized execution evidence through an authenticated API and its own PostgreSQL database.
